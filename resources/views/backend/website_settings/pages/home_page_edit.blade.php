...
<div class="row">
	<div class="col-xl-10 mx-auto">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner 1 (Max 3),(For 1 image the image size is 1500 X 319),(For 2 image the image size is 735 X 319),(For 3 image the image size is 480 X 319)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner 2 (Max 3),(For 1 image the image size is 1500 X 472),(For 2 image the image size is 735 X 472),(For 3 image the image size is 480 X 472)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Banner 3 (Max 3),(For 1 image the image size is 1500 X 319),(For 2 image the image size is 735 X 319),(For 3 image the image size is 480 X 319)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
		...
		{{-- Code cange by Brijesh on 04-April-22 CR#2 - start --}}
		{{-- Home Gift Delivery Content --}}
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home Gift Delivery Content') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group">
						...
						<div class="home-banner3-target">
							<input type="hidden" name="types[]" value="home_gift_delivery_content">
							<div class="row gutters-5">
								<div class="col-md-12">
									<div class="form-group">
										<textarea class="aiz-text-editor" name="home_gift_delivery_content">{{ get_setting('home_gift_delivery_content') }}</textarea>
									</div>
								</div>
							</div>
						</div>						
		...
		{{-- Code cange by Brijesh on 04-April-22 CR#2 - end --}}
