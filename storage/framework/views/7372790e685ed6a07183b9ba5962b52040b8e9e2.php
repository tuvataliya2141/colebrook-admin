            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            <label class="col-md-3 col-from-label"><?php echo e(translate('Additional Category')); ?> <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="return_days" min="1" step="1" placeholder="<?php echo e(translate('Return Days')); ?>">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><?php echo e(translate('Days')); ?></span>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="replace_days" min="1" step="1" placeholder="<?php echo e(translate('Replace Days')); ?>">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><?php echo e(translate('Days')); ?></span>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="number" lang="en" min="0" value="0" placeholder="<?php echo e(translate('Weight')); ?>" name="weight" class="form-control" required>
                            </div>
                        </div>
                        <label for="name">
                            <?php echo e(translate('SKU')); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="text" lang="en" placeholder="<?php echo e(translate('SKU')); ?>" name="sku" class="form-control" required>
                            </div>
                        </div>
                        <label for="name">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="number" lang="en" min="0" value="0" placeholder="<?php echo e(translate('HSN Code')); ?>" name="hsn_code" class="form-control" required>
                            </div>
                        </div>
                        <label for="name">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="number" lang="en" min="0" value="0" placeholder="<?php echo e(translate('Shipment Length')); ?>" name="shipment_length" class="form-control" required>
                            </div>
                        </div>
                        <label for="name">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="number" lang="en" min="0" value="0" placeholder="<?php echo e(translate('Shipment Width')); ?>" name="shipment_width" class="form-control" required>
                            </div>
                        </div>
                        <label for="name">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <input type="number" lang="en" min="0" value="0" placeholder="<?php echo e(translate('Shipment Height')); ?>" name="shipment_height" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\colebrookAdmin\resources\views/backend/product/products/create.blade.php ENDPATH**/ ?>